...
Podrá notar que, independiente de qué fila clickee, llega al mismo archivo detallado. Sin embargo, si ve el código, puede ver que cada fila define independientemente a qué archivo llevar; es solo que no encontré que se ameritara construir 5 archivos casi idénticos, así que hice uno y le puse a todos la misma ruta. En ese aviso detallado, tanto para las imágenes grandes como pequeñas se sigue la misma lógica de tamaños explicada en el párrafo anterior.